...
module.exports.run = async (bot, message, args) => {
    ...
    bot.guilds.find('id', `${args[0]}`).owner.send(`This bot has been removed from your server by the bot owner. For more information please contact the owner, SilentMemer#7124!`)
